...
% The code is adapted from the work of M. Mahooti and input data of the
% given problem is entertained to obtain the ground track plot.
%
% Tabulated Variables:
% a     = Semi-major axis of the orbit (m)
% ae    = Semi-major axis of the planet (m)
% i     = Inclination of the orbit
% M0    = Mean Anamoly (degree)
% Omega = RA of the ascending node (degree)
% omega = Argument of Perigee (degree)
% 
%--------------------------------------------------------------------------
